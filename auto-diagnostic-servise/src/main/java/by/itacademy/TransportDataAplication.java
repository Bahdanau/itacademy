...
import by.itacademy.readerjson.impl.FileTransportReaderJson;
...
public class TransportDataAplication {
    public static void main(String[] args) {
        System.out.println("Старт программы Диагностика транспорта");

        try {
            final FileTransportReaderJson reader = new FileTransportReaderJson("transport.json");
